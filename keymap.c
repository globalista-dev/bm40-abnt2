...
/* Raise
 * ,-----------------------------------------------------------------------------------.
 * |      |  /   |  ?   |      |  F1  |  F2  |  F3  |  F4  |  F5  | F6   |ALTGR |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CAPS |      |   Q  |      |  F7  |  F8  |  F9  |  F10 | F11  | F12  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   \  |   A  |   B  |   C  |  D   |  H   | Del  | Ins  |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |   P  |   T  |   S  |             |      | Home | PUp  | PDw  | End  |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_planck_mit(
    _______,   KC_RO, S(KC_RO),   _______, KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,   KC_RALT,  _______,
    KC_CAPS, _______, KC_Q, _______, KC_F7,    KC_F8,    KC_F9,    KC_F10,  KC_F11, KC_F12, _______, _______,
    _______, KC_NUBS, KC_A, KC_B, KC_C, KC_D, KC_H, KC_DEL, KC_INS, _______, _______, _______,
    _______, _______, KC_P, KC_T, KC_S, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END
),
...
[_FUNCTION] = LAYOUT_planck_mit(
    ...
    DBLY,   BL_DEC,   BL_INC, _______, _______,     GAME,      _______, KC_P0, KC_PDOT, KC_PPLS,  KC_PAST
),
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   ;  |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Win  | Alt  | Spc  |Lower |    Game     |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAME] = LAYOUT_planck_mit(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______,   _______,   _______, KC_SPC, _______,  GAME,      _______, _______, _______, _______, _______
)
